...
# alliage-collection-academy
ALLIAGE_COLLECTION_ACADEMY_URL=https://github.com/ALLIAGE-IO/alliage-collection-academy #https://github.com/ALLIAGE-IO/alliage-academy
ALLIAGE_ROLES_ACADEMY_PATH="$abs_root_dir/ansible_roles/collections/ansible_collections/alliage/alliage_academy"
...
if [ "$RELEASE" == "latest" ]; then
  ...
  [[ -d "$ALLIAGE_ROLES_ACADEMY_PATH" ]] || "$abs_root_dir/scripts/git-commit-download.sh" "$ALLIAGE_ROLES_ACADEMY_PATH" "$ALLIAGE_COLLECTION_ACADEMY_URL"
...
Copy the default tdp_vars from tdp-collection, tdp-collection-extras and alliage-collection-academy
...
TDP_COLLECTION_PATH="$TDP_ROLES_PATH:$TDP_ROLES_EXTRA_PATH:$ALLIAGE_ROLES_ACADEMY_PATH"
EOF
